  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "/music-mv",
        name: "music-mv",
        component: () => import("@/views/music/MVRouting.vue"),
      },
      {
        path: "mvplay-detail/:id",
        name: "mvplay-detail",
        component: () => import("@/views/music/MVplay.vue"),
      },
      {
        path: "/Chat-friends",
        name: "Chat-friends",
        ...
        component: () => import("@/views/Chat/ChatFriends.vue"),
      },
      {
        path: "/music-dynamic",
        name: "music-dynamic",
        component: () => import("@/views/dynamic/PublicDynamic.vue"),
      },
