...
//    根据手机号码查询用户
    ...
    public List<Consumer> phoneAllUser(@RequestParam("phone") String phone){
        return consumerService.numberAll(phone);
    }
    @ResponseBody
    @RequestMapping(value = "/user/upCode", method = RequestMethod.POST)
    //    改变用户在线状态
    public int upUserCode(@RequestParam("statusCode") Integer statusCode, @RequestParam("id")Integer id) {
        int flag = 0 ;
        flag =  consumerService.updataUserCode(statusCode, id);
        return flag;
    }
    //    返回男女性别总数
    @ResponseBody
    @RequestMapping(value = "/user/sexAll", method = RequestMethod.GET)
    List<Consumer>getUserSexAll(){
        return consumerService.getUserSex();
    }
    //  返回在线人数
    @ResponseBody
    @RequestMapping(value = "/user/status", method = RequestMethod.GET)
    public List<Consumer> getUserStatus(){
//        System.out.println("consumerService.getUserCode() = " + consumerService.getUserCode());
     return consumerService.getUserCode();
    }
    //<!--  返回所有用户地址-->
    @ResponseBody
    @RequestMapping(value = "/user/regionAll", method = RequestMethod.GET)
    public List<Consumer> getUserRegionAll(){
         return consumerService.getUserRegion();
    }
    ...
    public Object addUser(HttpServletRequest req) {
        ...
        String userPhoneNumber = phone_num;
        String email = req.getParameter("email").trim();
        String birth = req.getParameter("birth").trim();
        String introduction = req.getParameter("introduction").trim();
        String location = req.getParameter("location").trim();
        String avator = "/uimg/user.jpg";
        ...
        userMapper.addUser(username,password,userPhoneNumber);
        ...
        try {
            ...
            return new FatalMessage("邮箱或手机号码已存在").getMessage();
        }
    }
    ...
    public List<Consumer> userOfname(HttpServletRequest req) {
        String name = req.getParameter("name");
        return consumerService.nameAll(name);
    }
    /**
     * 删除用户
     */
    ...
    public Object updateUserPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) {
        ...
        String filePath=System.getProperty("user.dir")+"\\public\\uimg\\";
